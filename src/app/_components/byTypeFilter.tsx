...
function ByTypeFilterSection() {
  ...
  return (
    <section className=" w-1/2 h-36 grid grid-cols-4 gap-3 mt-6 border-b border-b-gray-300 max-lg:grid-cols-3 max-md:grid-cols-2  max-lg:w-2/3 max-lg:h-80">
